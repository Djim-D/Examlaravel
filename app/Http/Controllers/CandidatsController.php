...
class CandidatsController extends Controller
{
    ...
    {  
        $formations = Formation::all()->pluck('nom', 'id');
        $genre = ['Masculin', 'Feminin'];
        $niveau = ['Bac', 'Licence', 'Master'];
        return view('candidats.create', ['genre'=>$genre], ['niveau'=>$niveau])->with('formation',$formations);
    }
    ...
    public function store(CandidatRequest $request)
    {
		...
		$candidat->sexe = $sexe;
        $candidat->formation_id = $request->input('formation_id');
        //dd($candidat);
        $candidat->save();
